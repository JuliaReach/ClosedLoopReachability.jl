...
# a flying airplane [^MS20]. There are 12 state variables:
#
# ```math
# \begin{aligned}
...
# [^MS20]: Amir Maleki, Chelsea Sidrane, May 16, 2020,
#          [Benchmark Examples for AINNCS-2020](https://github.com/amaleki2/benchmark_closedloop_verification/blob/master/AINNC_benchmark.pdf).
